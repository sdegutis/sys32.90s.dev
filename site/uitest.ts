...
const box1 = new Box('box1', 10, 10, 20, 40, '#ff03');
root.children.push(box1);

const box2 = new Box('box2', 3, 3, 10, 10, '#0ff3');
box1.children.push(box2);

const button = new Button('button', 0, 30, 5, 5, '#f007');
box1.children.push(button);

const handle = new DragHandle(box1, 'draghandle', 0, 0, 8, 8, '#0003');
...
const cursor = new Box('cursor', 0, 0, 320, 180);
