...
import { makeFlowLayout } from "./crt/layouts.js";
import { RadioGroup, RadioButton } from "./crt/radio.js";
...
export default (screen: System) => {
  ...
  // b(SplitBox, { background: 0x333333ff, pos: 20 },
  //   b(Box, { layout: makeFlowLayout(1, 1) },
  //     gridButton,
  //     ...COLORS.map(col => b(RadioButton, {
  //       group: toolGroup,
